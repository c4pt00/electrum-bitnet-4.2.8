...
class TestBolt11(ElectrumTestCase):
    ...
    def test_roundtrip(self):
        ...
        tests = [
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, payment_secret=PAYMENT_SECRET, net=constants.Bitnet_IOTestnet, tags=[('f', 'mk2QpYatsKicvFVuTAQLBryyccRXMUaGHP'), ('h', longdescription), ('9', 0x28200)]),
        ...
        tests.extend([
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, net=constants.Bitnet_IOTestnet, tags=[('f', 'mk2QpYatsKicvFVuTAQLBryyccRXMUaGHP'), ('h', longdescription)]),
    ...
    def test_min_final_cltv_expiry_decoding(self):
        ...
        lnaddr = lndecode("",
                          net=constants.Bitnet_IOTestnet)
