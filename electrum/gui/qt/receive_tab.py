...
from .amountedit import AmountEdit, BITAmountEdit, SizedFreezableLineEdit
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        self.receive_amount_e = BITAmountEdit(self.window.get_decimal_point)
    ...
    def update_view_button(self):
        ...
        if i == 0:
            icon, text = read_QIcon("link.png"), _('Bitnet_IO URI')
        elif i == 1:
    ...
    def get_tab_data(self):
        i = self.config.GUI_QT_RECEIVE_TABS_INDEX
        if i == 0:
            out = self.URI, self.URI, self.URI_help, _('Bitnet_IO URI')
        elif i == 1:
