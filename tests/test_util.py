...
from electrum.bip21 import parse_bip21_URI, InvalidBitnet_IOURI
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_invalid_address(self):
        self.assertRaises(InvalidBitnet_IOURI, parse_bip21_URI, 'bitcoin:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(InvalidBitnet_IOURI, parse_bip21_URI, 'notbitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma')

    def test_parse_URI_parameter_pollution(self):
        self.assertRaises(InvalidBitnet_IOURI, parse_bip21_URI, 'bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?amount=0.0003&label=test&amount=30.0')
    ...
    def test_parse_URI_unsupported_req_key(self):
        ...
        self.assertRaises(InvalidBitnet_IOURI, parse_bip21_URI, 'bitcoin:TB1QXJ6KVTE6URY2MX695METFTFT7LR5HYK4M3VT5F?amount=0.00100000&label=test&req-test=1&somethingyoudontunderstand=50')
    ...
    def test_parse_URI_lightning_consistency(self):
        ...
        self.assertRaises(InvalidBitnet_IOURI, parse_bip21_URI, 'bitcoin:tb1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=lntb700u1p3kqy26pp5l7rj7w0u5sdsj24umzdlhdasdasdasdasd')
