...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ('imported',  _('Import Bitnet_IO addresses or private keys')),
        ]
...
class WCImport(WalletWizardComponent):
    def __init__(self, parent, wizard):
        WalletWizardComponent.__init__(self, parent, wizard, title=_('Import Bitnet_IO Addresses or Private Keys'))
        message = _(
            'Enter a list of Bitnet_IO addresses (this will create a watching-only wallet), or a list of private keys.')
