...
class TestPeerDirect(TestPeer):
    ...
    async def test_payment_recv_mpp_confusion1(self):
        ...
        #   - Bob creates invoice1: 1 BIT, H1, S1
        #   - Bob creates invoice2: 1 BIT, H2, S2;  both given to attacker to pay
        #   - Alice sends htlc1: 0.1 BIT, H1, S1  (total_msat=1 BIT)
        #   - Alice sends htlc2: 0.9 BIT, H2, S1  (total_msat=1 BIT)
    ...
    async def test_payment_recv_mpp_confusion2(self):
        """Regression test for https://github.com/spesmilo/electrum/security/advisories/GHSA-8r85-vp7r-hjxf"""
        # This test checks that the following attack does not work:
        #   - Bob creates invoice: 1 BIT
        #   - Alice sends htlc1: 0.1 BIT  (total_msat=0.2 BIT)
        #   - Alice sends htlc2: 0.1 BIT  (total_msat=1 BIT)
