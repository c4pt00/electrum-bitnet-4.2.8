...
from electrum.bitcoin import TOTAL_COIN_SUPPLY_LIMIT_IN_BIT
...
class QEConfig(AuthMixin, QObject):
    ...
    def btcAmountRegex(self):
        ...
        max_digits_before_dp = (
            len(str(TOTAL_COIN_SUPPLY_LIMIT_IN_BIT))
            + (base_unit_name_to_decimal_point("BIT") - decimal_point))
    ...
    def thousandsSeparator(self):
        return self.config.BIT_AMOUNTS_ADD_THOUSANDS_SEP
    ...
    def decimal_point(self):
        return self.config.BIT_AMOUNTS_DECIMAL_POINT
