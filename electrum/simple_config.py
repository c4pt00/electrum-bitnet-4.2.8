...
class SimpleConfig(Logger):
    ...
    def __init__(self, options=None, read_user_config_function=None,
        ...
        self.decimal_point = self.BIT_AMOUNTS_DECIMAL_POINT
        try:
            decimal_point_to_base_unit_name(self.decimal_point)
        except UnknownBaseUnit:
            self.decimal_point = DECIMAL_POINT_DEFAULT
        self.num_zeros = self.BIT_AMOUNTS_FORCE_NZEROS_AFTER_DECIMAL_POINT
        self.amt_precision_post_satoshi = self.BIT_AMOUNTS_PREC_POST_SAT
        self.amt_add_thousands_sep = self.BIT_AMOUNTS_ADD_THOUSANDS_SEP
    ...
    def fee_per_kb(self, dyn: bool=None, mempool: bool=None, fee_level: float=None) -> Optional[int]:
        ...
        """
        if constants.net is constants.Bitnet_IORegtest:
    ...
    def set_base_unit(self, unit):
        ...
        self.BIT_AMOUNTS_DECIMAL_POINT = self.decimal_point
    ...
    def _default_swapserver_url(self) -> str:
        if constants.net == constants.Bitnet_IOMainnet:
            default = 'https://swaps.electrum.org/api'
        elif constants.net == constants.Bitnet_IOTestnet:
...
Warning: setting this to too low will result in lots of payment failures."""),
    ...
    BIT_AMOUNTS_DECIMAL_POINT = ConfigVar('decimal_point', default=DECIMAL_POINT_DEFAULT, type_=int)
    BIT_AMOUNTS_FORCE_NZEROS_AFTER_DECIMAL_POINT = ConfigVar(
